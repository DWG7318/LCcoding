...
and iterated before Integration. Once accepted for a Feature Slice, it becomes the fixed
target until that slice is connected and accepted.
...
- locked pages, components, copy, interaction, and states;
