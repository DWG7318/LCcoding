...
REQUIRED=[
'VERSION','README.md','README.zh-CN.md','CONSTITUTION.md','SPEC.md','CHANGELOG.md','MIGRATION-1.1.1-TO-2.0.0.md','MIGRATION-2.0.0-TO-2.1.0.md','MIGRATION-2.1.0-TO-2.2.0.md','MIGRATION-2.2.0-TO-2.2.1.md','MIGRATION-2.2.1-TO-2.2.2.md','MIGRATION-2.2.2-TO-2.2.3.md','MIGRATION-2.2.3-TO-2.3.0.md','MIGRATION-2.3.0-TO-2.4.0.md','MIGRATION-2.4.0-TO-2.4.1.md','MIGRATION-2.4.1-TO-2.5.0.md',
...
def main():
    ...
    if (root/'VERSION').is_file() and (root/'VERSION').read_text().strip()!='2.5.0': errors.append('bad VERSION')
