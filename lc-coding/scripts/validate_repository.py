...
'lc-coding/SKILL.md','lc-coding/references/verification-de-duplication.md','lc-coding/references/proposal-readiness.md','lc-coding/references/service-topology.md','lc-coding/templates/PROPOSAL-READINESS.md','lc-coding/scripts/prc_check.py',
...
def main():
    ...
    if (root/'VERSION').is_file() and (root/'VERSION').read_text().strip()!='3.0.0': errors.append('bad VERSION')
