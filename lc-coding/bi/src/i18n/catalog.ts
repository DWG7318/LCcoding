...
export const CATALOG = {
  ...
  "row.operations_agent_integration": {
    en: "Operations Agent integration",
    zh_CN: "Operations Agent 集成",
  },
  ...
  "row.operations_slice_progress": {
    en: "Operations Slice count",
    zh_CN: "Operations Slice 数量",
  },
  ...
  "row.fixed_verified_defects": { en: "Fixed and verified defects", zh_CN: "已修复并复验缺陷" },
  ...
  "agent_applicability.applicable_extra": {
    en: "Applicable · EXTRA",
    zh_CN: "适用 · EXTRA",
  },
  "agent_applicability.applicable_core": {
    en: "Applicable · CORE",
    zh_CN: "适用 · CORE",
  },
  ...
  "phase.REAL_PRODUCT_INTEGRATION": {
    en: "Real Product Integration",
    zh_CN: "真实产品集成",
  },
  ...
  "step.ACCEPTANCE_ENVIRONMENT_READY": { en: "Acceptance Environment Ready", zh_CN: "验收环境就绪" },
