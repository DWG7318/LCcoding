...
$releaseInstallerName = "LCCoding-BI_4.0.1_x64-setup.exe"
$safeAssetPattern = '^[A-Za-z0-9][A-Za-z0-9._-]*$'
if ($version -ne "4.0.1" -or $releaseInstallerName -notmatch $safeAssetPattern) {
...
$provenance = [ordered]@{
  schema = "LCCoding 4.0.1 installer provenance"
