...
## 4.0 service route Workflow trace

| Service Route ID | Workflow ID | Workflow Capability ID |
|---|---|---|

For an accepted 4.0 Product Baseline, record one row for every required route in the adopted Service Route Map. The capability is the route's shared capability implementation; API or MCP evidence without this route trace does not establish route formation or delivery.
