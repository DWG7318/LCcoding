...
HISTORICAL_RECORD_HASHES = {
    ...
    "docs/superpowers/specs/2026-09-13-lccoding-4.0.1-ponytail-external-skill-governance-design.md": "79492431553134f8f7907248614b17f672de20f5a50bd3f3a440f13d95352555",
}
...
required_semantics = {
    ...
    "LC-PHASE-002": (
        ...
        "graphical UI is required only",
        "artificial UI is forbidden",
        "`WORKFLOW_UI_SIMULATION` remains a read-only compatibility name",
    ...
    "LC-FORM-001": (
        ...
        "applicable route ends advance independently",
        "Workflow-to-route connection",
        "Snake",
        "Scorpion",
    ),
    "LC-FORM-002": (
        ...
        "both API and MCP",
        "selects applicable product surfaces and adapters per delivered journey",
        "must not invent graphical UI",
        "CORE",
        "EXTRA",
        "worktree",
    ),
    "LC-FORM-003": (
        ...
        "route-specific surface or adapter",
        "A graphical UI participates only when promised by the route",
